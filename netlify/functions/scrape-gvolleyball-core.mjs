...
/**
 * Runs the full girls-volleyball scrape (Arbiter fetch → parse → sync → upsert).
 * Called by BOTH scheduled wrappers (regular and peak-hours). Returns a Response
 * with the same shape the wrappers should return to Netlify.
 */
